export default {
    ...
    REQUIRED_INFORMATION_NOT_PROVIDED: 'Required information not provided',
    SUCCESSFULLY_LOGGED_OUT: 'You have successfully logged out',
    TASK_SUCCESSFULLY_STARTED: 'Your task has been successfully started',
    UNAUTHORIZED_TO_PERFROM_OPERATION: 'You are not able to access this resource',
    ...
    ERROR_WHILE_PROCESSING_REQ: 'An error occurred while processing your request.',
